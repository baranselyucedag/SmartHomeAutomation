        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AutomationRules_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AutomationRules_Scenes_SceneId",
                        column: x => x.SceneId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceId = table.Column<int>(type: "integer", nullable: false),
                    TargetState = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SceneDevices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SceneDevices_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SceneDevices_Scenes_SceneId",
                        column: x => x.SceneId,
                        principalTable: "Scenes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomationRules_DeviceId",
                table: "AutomationRules",
                column: "DeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_AutomationRules_SceneId",
                table: "AutomationRules",
                column: "SceneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SceneDevices_DeviceId",
                table: "SceneDevices",
                column: "DeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_SceneDevices_SceneId",
                table: "SceneDevices",
                column: "SceneId");
